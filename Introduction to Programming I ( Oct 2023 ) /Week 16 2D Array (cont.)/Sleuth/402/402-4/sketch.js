...
Officer: 6174876
CaseNum: 402-3-41179648-6174876
...
function draw() {
	...
	if (det.locationY < 135 && det.locationX < 210) {
		det.speedX = 0;
		det.speedY = 1;
	} else if (det.locationY < 200 && det.locationX < 700) {
		det.speedX = 1;
		det.speedY = 0;
	} else if (det.locationY < 265 && det.locationX < 705) {
		det.speedX = 0;
		det.speedY = 1;

	} else if (det.locationY < 400 && det.locationX > 250) {
		det.speedX = -1;
		det.speedY = 0;
	} else if (det.locationY < 450 && det.locationX < 255) {
		det.speedX = 0;
		det.speedY = 1;
	} 
	else if (det.locationY < 500 && det.locationX < 820) {
		det.speedX = 1;
		det.speedY = 0;
	}
	 else if (det.locationY < 580 && det.locationX < 840) {
		det.speedX = 0;
		det.speedY = 1;
	}else if(det.locationY < 590 && det.locationX > 445){
		det.speedX = -1;
		det.speedY = 0;
	}else if(det.locationY < 640 && det.locationX < 450){
		det.speedX = 0;
		det.speedY = 1;
	}
	else if(det.locationY < 650 && det.locationX < 765){
		det.speedX = 1;
		det.speedY = 0;
	}else if(det.locationY < 715){
		det.speedX = 0
		det.speedY = 1;
