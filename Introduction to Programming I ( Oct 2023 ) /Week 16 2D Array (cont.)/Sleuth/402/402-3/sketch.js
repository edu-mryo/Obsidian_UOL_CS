...
Officer: 6174876
CaseNum: 402-2-20071191-6174876
...
function draw() {
	...
	if (det.locationX < 261) {
		det.speedX = 1;
		det.speedY = 0;
	}else if(det.locationY < 320){
		det.speedX = 0;
		det.speedY = 1;
	}else if(det.locationX < 570){
		det.speedX = 1;
		det.speedY = 0;
	}else if(det.locationY < 510){
		det.speedX = 0;
		det.speedY = 1;
	}else if(det.locationX < 885){
		det.speedX = 1;
		det.speedY = 0;
	}else if(det.locationY < 628){
		det.speedX =0;
		det.speedY = 1;
	}
