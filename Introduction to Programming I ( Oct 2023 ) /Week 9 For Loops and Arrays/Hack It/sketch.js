...
function setup() {
    ...
    robotWidths = [70, 100, 150, 50];
    robotHeights = [50, 120, 110, 10];
    headWidths = [0.7, 0.8, 1.2, 0.5];
}
...
function draw() {
    ...
    fill(200);
    rect(-robotWidths[3] / 2, -robotHeights[3] - 130, robotWidths[3], 130);
    rect(-70, -robotHeights[3] - 130, 30, 100);
    rect(40, -robotHeights[3] - 130, 30, 100);
    rect(-30, -robotHeights[3], 30, robotHeights[3]);
    rect(0, -robotHeights[3], 30, robotHeights[3]);
    ...
    //ears
    fill(255, 0, 0);
    rect(-50 * headWidths[3] - 10, -robotHeights[3] - 200, 10, 33);
    rect(50 * headWidths[3], -robotHeights[3] - 200, 10, 33);

    //robots' antennas
    fill(250, 250, 0);
    ellipse(0, -robotHeights[3] - 237, 10, 10);
    fill(200, 0, 200);
    rect(-10, -robotHeights[3] - 233, 20, 10);

    //robot's eyes
    fill(255);
    ellipse(-25 * headWidths[3], -robotHeights[3] - 200, 26, 26);
    point(-25 * headWidths[3], -robotHeights[3] - 200);
    ellipse(25 * headWidths[3], -robotHeights[3] - 200, 26, 26);
    point(25 * headWidths[3], -robotHeights[3] - 200);
    ...
    noFill();
    beginShape();
    vertex(-23, -robotHeights[3] - 155);
    vertex(-15, -robotHeights[3] - 145);
    vertex(-9, -robotHeights[3] - 155);
    vertex(-1, -robotHeights[3] - 145);
    vertex(7, -robotHeights[3] - 155);
    vertex(15, -robotHeights[3] - 145);
    vertex(23, -robotHeights[3] - 155);
    endShape();
}
